...
export async function liveRequest(action:string,input:unknown={},signal?:AbortSignal):Promise<LiveResponse>{
 ...
 try{
  ...
  if(!data)throw new Error('O servidor devolveu uma resposta inválida. Tenta novamente.');
